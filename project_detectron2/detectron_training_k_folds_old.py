...
class HubMapDataset:
    def __init__(self, data_dir):
        ...
        self.image_dir = os.path.join(data_dir, 'all_dataset_imgs')
        self.annotation_dir = os.path.join(data_dir, 'all_dataset_annotations')
...
train_dataset_name = 'hubmap-dataset-full'
train_dir = '/home/ec2-user/hubmap-hacking-the-human-vasculature/all_dataset_files'
num_machines = 1
num_gpus = 1
machine_rank = 0
